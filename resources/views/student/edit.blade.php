...
<div class="card-block">
    ...
    <div class="row">
        ...
        <input value="{{ $student->birth_date }}" required name="birth_date" type="text" class="form-control form-control-uppercase form-control-bold" placeholder="">
        </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <input value="{{ $student->guardian_phone_number }}" required name="guardian_phone_number" type="text" class="form-control form-control-uppercase form-control-bold" placeholder="">
        </div>
        </div>
    </div>
    <div class="row">
