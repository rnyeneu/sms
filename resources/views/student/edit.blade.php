...
<div class="page-body">
    ...
    <div class="card-block">
        ...
        <div class="row ">
            ...
            <input value="{{ $student->registration_number }}" required name="registration_number" type="text" class="form-control form-control-uppercase form-control-bold" placeholder="">
            </div>
            </div>
        </div>
        <div class="row">
            ...
            <input value="{{ $student->first_name }}" required name="first_name" type="text" class="form-control form-control-uppercase form-control-bold" placeholder="">
            </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="input-group">
            <span class="input-group-addon"><i class="icofont icofont-ui-user"></i></span>
            <input value="{{ $student->surname }}" required name="surname" type="text" class="form-control form-control-uppercase form-control-bold" placeholder="">
            </div>
            </div>
        </div>
        <div class="row">
            ...
            <input value="{{ $student->birth_date }}" required name="birth_date" type="text" class="form-control date2 form-control-bold" data-mask="9999-99-99" placeholder="YYYY-MM-DD">
            </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <select required name="disability" class=" form-control" >
                ...
                <option
                    @if($student->disability == "HI")
                    {{"selected"}}
                    @endif
                    value="HI">Hearing Impairement
                </option>
                <option
                    @if($student->disability == "II")
                    {{"selected"}}
                    @endif
                    value="II">Intellectual Impairement
                </option>
                <option
                    @if($student->disability == "LVI")
                    {{"selected"}}
                    @endif
                    value="LVI">Low Vision Impairement
                </option>
                <option
                    @if($student->disability == "HVI")
                    {{"selected"}}
                    @endif
                    value="HVI">High Vision Impairement
                </option>
            </select>
            </div>
            </div>
    ...
    <div class="card-block">
        ...
        <div class="row">
            ...
            <div class="input-group">
            <span class="input-group-addon"><i class="icofont icofont-ui-user"></i></span>
            <input value="{{ $student->guardian_first_name }}" required name="guardian_first_name" type="text" class="form-control form-control-uppercase form-control-bold" placeholder="">
            </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="input-group">
            <span class="input-group-addon"><i class="icofont icofont-ui-user"></i></span>
            <input value="{{ $student->guardian_surname }}" required name="guardian_surname" type="text" class="form-control form-control-uppercase form-control-bold" placeholder="">
            </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <select required name="guardian_sex" class=" form-control" >
                <option>Select Sex</option>
                <option
                    @if($student->guardian_sex == "M")
                    {{"selected"}}
                    @endif
                    value="M">Male
                </option>
                <option
                    @if($student->guardian_sex == "F")
                    {{"selected"}}
                    @endif
                    value="F">Female
                </option>>
        ...
        <div class="row">
            ...
            <input value="{{ $student->guardian_phone_number }}" required name="guardian_phone_number" type="text" data-mask="9999999999" class="mob_no form-control form-control-uppercase form-control-bold" placeholder="">
            </div>
            </div>
        </div>
        <div class="row">
            ...
            <input value="{{ $student->address }}" required name="address" type="text" class="form-control form-control-uppercase form-control-bold" placeholder="">
            </div>
            </div>
        </div>
        <div class="row">
