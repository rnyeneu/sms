...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('custom/assets/pages/dashboard/horizontal-timeline/css/style.css') }}">

    <link rel="stylesheet" type="text/css"
        href="{{ asset('custom/assets/pages/dashboard/amchart/css/amchart.css') }}">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="media">
                                                            <img class="d-flex mr-3 img-circle img-40 img-thumbnail"
                                                                src="{{ asset('custom/assets/images/user-card/img-round1.jpg') }}"
...
<![endif]-->
    ...
    <script type="text/javascript" src="{{ asset('custom/assets/pages/dashboard/horizontal-timeline/js/main.js') }}">
    </script>
    ...
    <script type="text/javascript" src="{{ asset('custom/assets/pages/dashboard/amchart/js/custom-amchart.js') }}">
    </script>
